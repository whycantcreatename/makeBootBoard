package com.board.bootBoard.config;
...
import com.board.bootBoard.member.handler.AuthFailureHandler;
import com.board.bootBoard.member.handler.AuthSucessHandler;
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		*/
        ...
        http.csrf().disable()	// csrf 토큰을 비활성화
			...
			.antMatchers("/","/login/**","/js/**","/css/**","/image/**", "/join/**").permitAll() // 해당 경로들은 접근을 허용
